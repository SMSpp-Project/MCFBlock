...
/** @name Methods for checking the Block
  ...
  * MCFBlock to have been defined, i.e., that generate_static_variables() has
  ...
  * been generated by calling generate_static_constraints() prior to this
  * method. */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  * have been defined, i.e., that generate_static_variables() has been
  ...
  * by calling generate_static_constraints() prior to this method. */
...
/*- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
  ...
  * have been generated by calling generate_static_variables() and
  * generate_static_constraints() prior to this method. The parameters ceps
...
/*--------------------------------------------------------------------------*/
  ...
  * generate_static_variables() has been called prior to this method. Also,
...
/*--------------------------------------------------------------------------*/
  ...
  * MCFBlock to have been defined, i.e., that generate_static_variables() and
  * generate_static_constraints() have been called prior to this method.
  *
